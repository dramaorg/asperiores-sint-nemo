# @dramaorg/asperiores-sint-nemo

![CI](https://github.com/dramaorg/asperiores-sint-nemo/workflows/CI/badge.svg)
[![NPM version](https://img.shields.io/npm/v/@dramaorg/asperiores-sint-nemo.svg?style=flat)](https://www.npmjs.com/package/@dramaorg/asperiores-sint-nemo)
...
## Install
```
npm i @dramaorg/asperiores-sint-nemo
```
...
fastify.register(require('@dramaorg/asperiores-sint-nemo'))
